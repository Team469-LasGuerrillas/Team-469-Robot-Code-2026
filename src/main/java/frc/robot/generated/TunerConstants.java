...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(88.8).withKI(0).withKD(0).withKS(1.33).withKV(0);
  ...
  private static final Current kSlipCurrent = Amps.of(86.7);
  ...
  public static final CANBus kCANBus = new CANBus("469Canivore", "./logs/example.hoot");

  // Theoretical free speed (m/s) at 12 V applied output;
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.36);
  ...
  private static final Distance kWheelRadius = Inches.of(1.987);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.103759765625);
