...
public class GeomUtil {
  ...
  public static Pose2d toPose2d(ChassisSpeeds speeds) {
    return new Pose2d(
  ...
  public static ChassisSpeeds toChassisSpeeds(Pose2d speedsPose) {
    return new ChassisSpeeds(
        speedsPose.getX(), speedsPose.getY(), speedsPose.getRotation().getRadians());
  }
