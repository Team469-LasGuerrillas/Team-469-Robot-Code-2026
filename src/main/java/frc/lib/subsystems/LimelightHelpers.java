...
import frc.lib.subsystems.LimelightHelpers.LimelightResults;
import frc.lib.subsystems.LimelightHelpers.PoseEstimate;
...
public class LimelightHelpers {
   ...
   * @return
   */
  public static Pose3d getBotPose3d_wpiBlue_MegaTag2(String limelightName) {
    double[] poseArray = getLimelightNTDoubleArray(limelightName, "botpose_orb_wpiblue");
    return toPose3D(poseArray);
  }
